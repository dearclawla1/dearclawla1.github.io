...
// ============================================================
// DRAW FOG OVERLAY - Radial Gradient Shadow System (Alternative Implementation)
// ============================================================
...
// ============================================================
// DRAW FOG OVERLAY - Radial Gradient Shadow System (Extended Version)
// ============================================================
function drawFogExtended() {
  if (!currentZone || !player) return;
  const ts = currentZone.tileSize;
  const playerStats = getPlayerStats();
  const shadowRadius = playerStats.radiusShadows || 100;
...
// ============================================================
// DRAW FOG OVERLAY - Radial Gradient Shadow System (Complete Version)
// ============================================================
function drawFogComplete() {
  if (!currentZone || !player) return;
  const ts = currentZone.tileSize;
  const playerStats = getPlayerStats();
  const shadowRadius = playerStats.radiusShadows || 100;
...
// ============================================================
// DRAW FOG OVERLAY - Radial Gradient Shadow System (Final Implementation)
// ============================================================
